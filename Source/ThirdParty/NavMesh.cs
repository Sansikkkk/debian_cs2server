...
public class NavMesh
{
    ...
    private static List<SpawnPoint> GetSpawnPoints()
    {
        ...
        spawnPoints.AddRange(GetVectorPtrElements(gameRules.CTSpawnPoints).Select(h => h.Value).Where(v => v != null)!);
        spawnPoints.AddRange(GetVectorPtrElements(gameRules.TerroristSpawnPoints).Select(h => h.Value).Where(v => v != null)!);
        return spawnPoints;
    }
